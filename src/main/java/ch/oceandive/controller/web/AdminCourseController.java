...
public class AdminCourseController {
  ...
  public String createCourse(
    ...
    try {
      ...
      Course createdCourse = courseService.adminCreateCourse(course);
  ...
  public String updateCourse(
    ...
    try {
      ...
      Course updatedCourse = courseService.adminUpdateCourse(id, course);
      ...
      switch (action) {
        case "publish":
          for (Long id : courseIds) {
            courseService.changeStatus(id, PublicationStatus.PUBLISHED);
            successCount++;
          }
          redirectAttributes.addFlashAttribute("successMessage",
        ...
        case "archive":
          for (Long id : courseIds) {
            courseService.changeStatus(id, PublicationStatus.ARCHIVED);
            successCount++;
          }
          redirectAttributes.addFlashAttribute("successMessage",
