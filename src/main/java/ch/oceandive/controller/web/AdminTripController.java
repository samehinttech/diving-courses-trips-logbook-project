...
/**
 * Web-based admin controller for managing trips from the admin dashboard.
 */
@Controller
  ...
  public String listTrips(
    ...
    try {
      ...
      if (search != null && !search.trim().isEmpty()) {
        // For simplicity, we'll get all trips and filter manually
        // In a real application, you'd want to add search methods to TripRepo
