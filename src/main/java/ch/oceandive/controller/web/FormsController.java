...
// Controller for handling web forms, specifically the contact form. Which is used only for illustration purposes
@Controller
public class FormsController {
  ...
  // Placeholder method to simulate processing the contact form submission
