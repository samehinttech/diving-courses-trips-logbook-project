...
public class ValidationException extends RuntimeException {
  ...
  @Serial
  private static final long serialVersionUID = 1L; // for serialization (Note: L is casting for Long)
  ...
  /**
   * ValidationException with the specified detail message and errors.
   */
