 ...
 * This class has no use for the current implementation,
 */
@Service
public class GuestUserService {
 ...
 // Get a guest user entity by ID.
   ...
   // Get a guest user by mobile number.
    ...
    // Create a new guest user. not Active for now, but can be used later for booking purposes.
    @Transactional
    ...
    // Update an existing guest user. Not Active for now, but can be used later.
    @Transactional
